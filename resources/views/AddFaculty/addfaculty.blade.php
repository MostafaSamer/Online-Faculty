<form class="" action="/faculty/add" method="post" enctype="multipart/form-data">
  @csrf
  <div class="form-group mx-sm-3 mb-2">
      ...
      <input style="box-shadow: 1px 1px 4px #ccc; margin-top: 14px" class="form-control" type="file" name="cover_image" id="cover_image">
